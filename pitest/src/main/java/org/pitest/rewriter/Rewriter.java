...
//    }
    ...
    public static <T> void assertThat(String reason, T actual, Matcher<? super T> matcher, String id_assertion) {
        Serializer.serialize(id_assertion, matcher.matches(actual), AssertParser.getObjectContent(actual));
    }
    ...
    public static void assertArrayEquals(boolean[] expecteds, boolean[] actuals, String id_assertion) {
        Serializer.serialize(id_assertion, Utility.getAssertRes(expecteds, actuals),AssertParser.getArrayContents(expecteds) + "" + AssertParser.getArrayContents(actuals));
    }
    ...
    public static void assertArrayEquals(double[] expecteds, double[] actuals, double delta, String id_assertion) {
        Serializer.serialize(id_assertion, Utility.getAssertRes(expecteds, actuals, delta),AssertParser.getArrayContents(expecteds) + "" + AssertParser.getArrayContents(actuals));
    }
    ...
    public static void assertEquals(Object expected, Object actual,
        ...
        Serializer.serialize(id_assertion,
                (Utility.compareObject(expected, actual)),
                AssertParser.getObjectContent(expected) + ""
                        + AssertParser.getObjectContent(actual));
    }
    ...
    public static void assertNotEquals(Object unexpected, Object actual,
        ...
        Serializer.serialize(id_assertion,
                ...
                AssertParser.getObjectContent(unexpected) + ""
                        + AssertParser.getObjectContent(actual));
    ...
    public static void assertNotNull(Object object, String id_assertion) {
        Serializer.serialize(id_assertion, (object != null),
                AssertParser.getObjectContent(object));
    }
    ...
    public static void assertSame(Object expected, Object actual, String id_assertion) {
        Serializer.serialize(id_assertion, (actual == expected),AssertParser.getObjectContent(expected) + "" + AssertParser.getObjectContent(actual));
    }
...
//        Serializer.serialize(id_assertion, Utility.compareObject(expected, actual));
//    }
//
...
//        Serializer.serialize(id_assertion, (Utility.compareObject(actual, expected)));
//    }
//
...
//        Serializer.serialize(id_assertion, (!Utility.compareObject(unexpected, actual)));
//
//    }
//
