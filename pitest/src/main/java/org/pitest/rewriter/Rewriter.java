...
public class Rewriter {
    ...
    public static void assertEquals(short expected, short actual, String id_assertion) {
        Serializer.serialize(id_assertion, expected == actual,expected + "" + actual);
    }
    public static void assertEquals(String message, short expected, short actual, String id_assertion) {
        Serializer.serialize(id_assertion, expected == actual,expected + "" + actual);
    }
    ...
    public static void assertEquals(double expected, double actual, String id_assertion) {
        Serializer.serialize(id_assertion, (actual == expected),expected + "" + actual);
    }
    ...
    public static void assertEquals(double expected, double actual, double delta, String id_assertion) {
        Serializer.serialize(id_assertion, (Math.abs(actual - expected) <= delta), expected + "" + actual);
    }
    ...
    public static void assertEquals(String expected, String actual, String id_assertion) {
        // bug fix
        Serializer.serialize(id_assertion, Utility.compareObject(expected, actual),expected + "" + actual);
    }
    ...
    public static void assertEquals(Object[] expecteds, Object[] actuals, String id_assertion) {
        Serializer.serialize(id_assertion, (Utility.getAssertRes(expecteds, actuals)), expecteds,actuals);
    }
    ...
    public static void assertNotEquals(double unexpected, double actual, double delta, String id_assertion) {
        Serializer.serialize(id_assertion, (Math.abs(actual - unexpected) > delta),unexpected + "" + actual);
    }
    ...
    public static void assertNotEquals(long unexpected, long actual, String id_assertion) {
        Serializer.serialize(id_assertion, (actual != unexpected),unexpected + "" + actual);
    }

    public static void assertNotEquals(Object unexpected, Object actual, String id_assertion) {
        Serializer.serialize(id_assertion, (!Utility.compareObject(unexpected, actual)), unexpected,actual);
    }
    ...
    public static void assertNotEquals(String message, long unexpected, long actual, String id_assertion) {
        Serializer.serialize(id_assertion, (unexpected != actual),unexpected + "" + actual);
    }
    ...
    public static void assertNotNull(Object object, String id_assertion) {
        Serializer.serialize(id_assertion, (object != null), object);
    }
